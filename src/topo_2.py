...
def run_topology():
    ...
    print("*** [Test] Disparando los 3 clientes de forma simultánea...")
    client1.cmd('python3 upload -H 10.0.0.1 -p 8080 -s ../documentos/test_15mb.bin -n test_15mb.bin -r sr -v > h2.log 2>&1 &')
    client2.cmd('python3 upload -H 10.0.0.1 -p 8080 -s ../documentos/test_15mb_2.bin -n test_15mb_2.bin -r sr -v > h3.log 2>&1 &')
    client3.cmd('python3 upload -H 10.0.0.1 -p 8080 -s ../documentos/test_15mb_3.bin -n test_15mb_3.bin -r sr -v > h4.log 2>&1 &')
    print("*** [Test] Transferencias iniciadas. Revisa los .log para ver el progreso.")
